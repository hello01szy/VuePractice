		...
		<el-card class="box-card">
  		...
  		<div class="buttons">
    		<el-radio-group v-model="choose" size="mini" @change="chooseStatus">
				...
				<el-button type="success" size="mini" @click="dialogTableVisible = true">添加素材</el-button>
  		</div>
			<div>
					<el-row :gutter="20">
						<el-col v-for="(image, index) in images" :key="index" :span="4" :xs="8">
							<div class="rowImg" @mouseenter="enter" @mouseleave="leave">
								...
								<div id="icon" :class="{colOrDel:isShow===image.id}">
